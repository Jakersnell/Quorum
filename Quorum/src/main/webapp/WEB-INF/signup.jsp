					...
					<div class="card shadow p-3 mb-5 rounded" id="logincard">
						...
						<div class="card-body" id="logincard">
							<form action="signup.do" method="POST">
								...
								<div class="row mb-3">
									<input class="form-control login-form rounded bg-white"
										type="email" name="email" placeholder="email" /> <label
								...
								<div class="row mb-3">
									<input class="form-control login-form rounded bg-white"
										type="text" name="lastName" placeholder="Last Name" /> <label
										for="lastName">lastName</label>
								</div>
								<div class="row mb-3">
									<select name="schoolID" id="schoolID" class="form-select"
										aria-label="School" required>
