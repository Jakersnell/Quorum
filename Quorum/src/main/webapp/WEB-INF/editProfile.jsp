						...
						<form action="update.do">
							...
							<div class="row mb-3">
								<label for="lastName">Last Name:</label> <input
									class="form-control" type="text" class="lastName"
							...
							<div class="row mb-3">
								<label for="username">Username:</label> <input
									class="form-control" type="text" class="username"
									name="username" id="username" value="${user.username }"
									required /><br />
							</div>
							<div class="row mb-3">
								<label for="password">Password:</label> <input
									class="form-control" type="text" class="password"
							...
							<div class="row mb-3">
								<label for="profileImageUrl">Profile pic url:</label> <input
									type="text" class="form-control" name="profileImageUrl"
