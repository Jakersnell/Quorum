...
<html>
  ...
  <body>
	...
	<div class="row">
		...
		<div class="col-4">
				<a
				class="nav-link btn btn-secondary form-control"
				href="getFollow.do?userID=${user.id}"
				>followers</a
				>
			...
			<div class="col-2">
				<c:if test="${userEditAuth}">
					...
					class="btn btn-info"
					role="button"
					href="editProfile.do?userID=${user.id}"
					>Edit Profile</a
					>
				</c:if>
			</div>
	...
	<div class="row">
		...
		<div class="col-4">
			<h4>Bio</h4>
			<p>
				<em>"<c:out value="${user.biography}"></c:out>"</em>
			</p>
		</div>
		<div class="col-4">
	...
	<div class="row"> 
		...
		<div class="col-2">
			<a
				class="btn btn-info"
				role="button"
				href="message.do?userID=${user.id}"
				>Message</a
				>
		</div>
		<div class="col-2">
